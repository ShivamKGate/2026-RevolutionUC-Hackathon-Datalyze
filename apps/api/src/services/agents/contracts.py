...
AGENT_CONTRACTS: dict[str, AgentContract] = {
    ...
    "file_type_classifier": AgentContract(
        ...
        required_keys=["file_routing_map", "metadata_tags"],
    ...
    "pdf_processor": AgentContract(
        ...
        required_keys=["chunks", "column_metadata", "data_preview", "detected_schema", "page_map", "chart_suggestions"],
    ...
    "csv_processor": AgentContract(
        ...
        required_keys=["rows_summary", "column_metadata", "data_preview", "detected_schema", "stats", "chart_suggestions"],
    ...
    "excel_processor": AgentContract(
        ...
        required_keys=["sheets", "column_metadata", "data_preview", "detected_schema", "workbook_metadata", "chart_suggestions"],
    ...
    "json_processor": AgentContract(
        ...
        required_keys=["records", "column_metadata", "data_preview", "detected_schema", "nested_map", "chart_suggestions"],
    ...
    "plain_text_processor": AgentContract(
        ...
        required_keys=["chunks", "column_metadata", "data_preview", "detected_schema", "semantic_tags", "chart_suggestions"],
    ...
    "aggregator": AgentContract(
        agent_id="aggregator",
        required_keys=["corpus", "usefulness_scores", "storyline_hypotheses", "categorized_signals", "chart_suggestions"],
    ...
    "conflict_detection": AgentContract(
        ...
        required_keys=["contradictions", "supporting_references", "chart_suggestions"],
    ...
    "knowledge_graph_builder": AgentContract(
        ...
        required_keys=["nodes", "edges", "clusters", "chart_suggestions"],
        optional_keys=["node_types", "edge_types"],
        strictness="guarded",
        token_budget=1200,
    ...
    "trend_forecasting": AgentContract(
        ...
        required_keys=["forecasts", "drivers", "anomalies", "chart_suggestions"],
        optional_keys=["methodology", "data_points_used"],
        strictness="guarded",
        token_budget=800,
    ...
    "sentiment_analysis": AgentContract(
        ...
        required_keys=["sentiments", "trend_summary", "sentiment_distribution", "chart_suggestions"],
        optional_keys=["source_channels", "sample_quotes"],
        strictness="strict",
        token_budget=600,
    ...
    "insight_generation": AgentContract(
        ...
        required_keys=["insights", "recommendations", "chart_suggestions"],
        optional_keys=["impact_rankings"],
        strictness="guarded",
        token_budget=1000,
    ...
    "swot_analysis": AgentContract(
        ...
        required_keys=["strengths", "weaknesses", "opportunities", "threats", "chart_suggestions"],
    ...
    "executive_summary": AgentContract(
        ...
        required_keys=["headline", "situation_overview", "key_findings", "risk_highlights", "next_actions", "confidence_statement", "chart_suggestions"],
        optional_keys=[],
        strictness="guarded",
        token_budget=800,
    ...
    "automation_strategy": AgentContract(
        ...
        required_keys=["processes", "bottlenecks", "sop_draft", "chart_suggestions"],
        optional_keys=[],
        strictness="guarded",
        token_budget=800,
    ...
    "output_evaluator": AgentContract(
